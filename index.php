...
<body>
    <div class="container">
        ...
        <nav>
            ...
            <div class="nav-toggle-icon"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
        ...
        <div class="intro-container">
            <div class="intro-img-container">
                <img src="./assets/img/ecommerce-2140603_1280.jpg" alt="" loading="lazy">
            </div>
        ...
        <section class="news">
            ...
            <div class="new-container">
                <?php foreach ($post->getLastRandomPost() as $post): ?>
                        ...
                        <div class="post-footer">
                            ...
                            <div class="likes">
                                <p><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    <?= $post['post_likes'] ?> interessé(e)
                                    <?php if ((int)($post['post_likes']) > 1) {
                                        echo 's';
                                    } ?>
                                </p>
                            </div>
        ...
        <!--section annonces  -->
        <section class="annonces" id="emplois-container">
            <h2>Emplois</h2>
            <div class="new-container">
                <div class="post-container">
                    <div class="post-date">
        ...
        <section class="contact">
            ...
            <form method="post">
                ...
                <input type="text" name="subject" placeholder="le subject" required>
                <label for="message">Message</label>
                <textarea name="message" id="message" cols="30" rows="10" placeholder="Votre message ici..."
                    required></textarea>
                <input type="submit" name="send" id="form-envoyer" value="Envoyer">
            </form>
        </section>

        <!-- section footer -->
        <footer>
            <h4>Suivez nous sur les reseaux</h4>
            <div class="rs-links">
            ...
            <div class="access">
                ...
                <a href="index.html">Inviter des amis</a>
            </div>
            <div class="themes">
                <h5>Thème</h5>
                <svg class="clair-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <svg class="sombre-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <p class="author">
                ...
                </svg> 2023 Brandon Fidelin Ravomanana.
            </p>
        </footer>
    </div>
